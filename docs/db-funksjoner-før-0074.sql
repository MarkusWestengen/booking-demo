...
begin
  ...
  if coalesce(new.email, '') <> '' then
    customer_html :=
      ...
      ||   '<div style="font-family:Georgia,serif;font-size:24px;letter-spacing:0.30em;color:#FAF7F1;">[TIDLIGERE&nbsp;NAVN]</div>'
...
-- to har «[TIDLIGERE&nbsp;NAVN]» i e-posthodet paa samme maate.
--
