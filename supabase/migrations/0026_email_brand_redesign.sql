...
begin
  ...
  notify_html :=
    ...
    ||   '<div style="font-family:Helvetica,Arial,sans-serif; font-size:12px; line-height:1.7; color:#8f9089; padding-top:9px;">Eksempelveien 12, 0000 Oslo<br>+47 400 00 000</div>'
