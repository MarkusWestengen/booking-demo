...
--      tid, pris, adresse (Eksempelveien 12, 0000 Oslo) — pluss
...
begin
  ...
  if coalesce(new.email, '') <> '' then
    customer_html :=
      ...
      ||       '<td style="padding:12px 0;border-bottom:1px solid #ECE6DA;font-family:Helvetica,Arial,sans-serif;font-size:15px;color:#15191A;">Eksempelveien 12, 0000 Oslo</td></tr>'
      ...
      ||   '<div style="font-family:Courier,monospace;font-size:10px;letter-spacing:0.14em;color:#5f6058;">WESTENGEN KLINIKK · EKSEMPELVEIEN 12, 0000 OSLO · +47 400 00 000</div>'
      || '</td></tr>'
