-- ============================================================
-- Westengen Klinikk — Markus: flat pris kr 4 000
-- Migration 0030
-- ------------------------------------------------------------
-- Markus Westengen skal koste kr 4 000 UANSETT om timen er en
-- førstegangskonsultasjon eller videre behandling. Seed (0008) ga:
--   markus-konsult → 4000  (allerede riktig)
--   markus-videre  → 3000  (skal opp til 4000)
...
-- denne migrasjonen er kjørt vises og lagres kr 4 000 for begge Markus-
...
-- uansett markus-videre = 4000 (idempotent — trygt å kjøre flere ganger).
--
...
declare
  r record;
begin
  raise notice 'Markus-priser FØR 0030:';
  for r in
...
-- ----- MUTATION -----------------------------------------------
-- Sett videre behandling med Markus til samme pris som konsultasjon.
