-- ============================================================
-- Westengen Klinikk — Erik «videre behandling» kr 4 000 → kr 3 000
-- Migration 0044
-- ------------------------------------------------------------
-- Erik Westengen skal IKKE lenger ha flat pris. Prisene splittes
-- igjen slik at videre behandling er rimeligere enn førstegangs-
-- konsultasjonen:
--   erik-konsult → 4000  (UENDRET — førstegangskonsultasjon)
--   erik-videre  → 3000  (ned fra 4000, satt av 0030)
-- Dette reverserer effekten av migrasjon 0030 (som satte erik-videre
...
-- denne migrasjonen er kjørt vises og lagres kr 3 000 for Erik «videre
...
-- at du ser utgangspunktet. UPDATE-en setter uansett erik-videre =
...
declare
  r record;
begin
  raise notice 'Erik-priser FØR 0044:';
  for r in
...
-- ----- MUTATION -----------------------------------------------
-- Sett videre behandling med Erik ned til kr 3 000.
...
--    where slug like 'tom-%'
--    order by sort_order;
-- Forvent: erik-konsult = 4000 OG erik-videre = 3000.
--
